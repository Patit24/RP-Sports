    ...
    <div className="max-w-7xl mx-auto pb-16">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <Link 
          ...
          className="px-5 py-2.5 bg-[#CC0000] text-white font-display font-bold uppercase tracking-wider text-xs sm:text-sm rounded-xl hover:bg-red-700 transition-all flex items-center gap-2 shadow-md shadow-red-600/20 whitespace-nowrap cursor-pointer self-start sm:self-auto"
              ...
              <div key={p.id} className="p-4 flex flex-col gap-3 hover:bg-slate-50 transition-colors">
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-1.5 flex-wrap">
                      <p className="font-bold text-primary text-sm leading-tight truncate">{p.name}</p>
                      {p.badge && (
                        <span className="text-[9px] uppercase font-bold px-1.5 py-0.5 rounded bg-red-100 text-[#CC0000]">
                          {p.badge}
                        </span>
                      )}
                      {p.featured && (
                    ...
                    <p className="text-[11px] text-slate-400 font-mono mt-0.5">
                      SKU: {p.sku || p.id} • {p.category}
                    </p>

                    <div className="flex items-center justify-between mt-2">
                      <div>
                        <span className="font-black text-sm text-[#CC0000]">₹{p.price.toLocaleString("en-IN")}</span>
                ...
                <div className="grid grid-cols-3 gap-2 pt-2 border-t border-slate-100">
                  <button
                    ...
                    className="py-2 px-2 bg-[#111111] hover:bg-[#CC0000] text-white rounded-lg text-xs font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-1.5 shadow-sm"
                  >
                  ...
                  <button
                    ...
                    className="py-2 px-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg text-xs font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-1.5 shadow-sm"
                  >
                  ...
                  <button
                    ...
                    className="py-2 px-2 bg-red-50 hover:bg-red-100 text-red-600 rounded-lg text-xs font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-1.5 border border-red-200"
                  >
